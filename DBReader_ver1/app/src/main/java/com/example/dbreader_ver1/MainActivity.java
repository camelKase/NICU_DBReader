...
public class MainActivity extends AppCompatActivity {
    ...
    private void initListButton() {
        Button ibList = findViewById(R.id.settingsButton);
        ibList.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                // Calling the stopRecorder method to allow re-initialization of the mRecorder when
                // you return to the main page and tap Listen.
                stopRecorder();
            }
        });
    }
    ...
    private void initCallibration() {
        Button ibList = findViewById(R.id.callibrateButton);
        ibList.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
    ...
    // This calculation was derived from this link:
    // https://stackoverflow.com/questions/10655703/what-does-androids-getmaxamplitude-function-for-the-mediarecorder-actually-gi
    // We are reading sound from the device using the MediaRecorder's 'getMaxAmplitude' method.
     ...
     * vibrates the phone 5 times to notify user that the db treshold has been
     * exceeded
     * @param Db the decibel reading of the ambient noise
     */
